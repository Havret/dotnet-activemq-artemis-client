...
The library is tested against **ActiveMQ Artemis 2.24.0** ([Aug 4th, 2022](https://github.com/Havret/dotnet-activemq-artemis-client/issues/356)). Most of the features should work with older versions of the broker, but **Topology Management** uses API surface that was introduced in **ActiveMQ Artemis 2.14.0**.
