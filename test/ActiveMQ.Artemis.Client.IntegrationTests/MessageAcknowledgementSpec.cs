...
namespace ActiveMQ.Artemis.Client.IntegrationTests
{
    public class MessageAcknowledgementSpec : ActiveMQNetIntegrationSpec
    {
        ...
        public async Task Should_acknowledge_message()
        {
            ...
            var consumer1 = await connection.CreateConsumerAsync(address, QueueRoutingType.Anycast);
            ...
            var consumer2 = await connection.CreateConsumerAsync(address, QueueRoutingType.Anycast);
